...
├── nlp_engine.py           # Qwen + NLLB pipeline (Q&A + summarization)
├── vector_store.py         # FAISS ingestion, chunking, and search
├── knowledge_graph.py      # spaCy NER + NetworkX + PyVis graph builder
├── readability_utils.py    # Textstat-based readability metrics
├── db.py                   # SQLite helpers (users, OTP, activity, feedback)
├── documents/              # Policy PDFs stored on Google Drive
├── graphs/                 # Generated knowledge graph HTML files
├── faiss_index.bin         # Persisted FAISS index (Google Drive)
...
### Knowledge Graph
<img width="1600" height="836" alt="image" src="https://github.com/user-attachments/assets/0c13469c-b56d-44ac-9201-f10fe4b4818c" />
<img width="1600" height="837" alt="image" src="https://github.com/user-attachments/assets/ba4f47b7-a762-4326-a9a4-1a949c1d5f98" />
